    ...
    <div className="border rounded-md overflow-hidden bg-white flex flex-col">
      ...
      {isCanceled && (
        <div className="p-4 flex justify-center items-center border-t">
          <div className="w-full bg-red-100 border border-red-100 font-medium px-4 py-3 rounded flex items-center">
            <div className="flex items-center">
              <CircleX className="size-6 mr-2 fill-red-500 text-red-100" />
